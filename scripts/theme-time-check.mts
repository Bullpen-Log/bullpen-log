 ...
 *   npm run theme:check
 *
 * 실제 등록된 운동으로, 테마 4가지 × 목표 3가지 × 그 목표의 시간을 모두 만들어 보고
 ...
 *
 * 무게를 드는 두 목표는 45·60·75·90분, 컨디셔닝은 45·60·75분이다. 목록이 겹치더라도
 * 목표마다 구성이 달라서(컨디셔닝은 가동성·코어·보강) 목표별로 따로 돈다 —
 * 실제로 고를 수 있는 조합만 골라 돈다.
 */
