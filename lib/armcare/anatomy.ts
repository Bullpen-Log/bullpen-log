...
export const ARMCARE_AREAS: readonly ArmcareArea[] = [
  ...
  },
  {
    ...
    notes: [
      '공을 놓은 뒤 팔꿈치가 펴지는 빠르기를 이두근 쪽 근육이 늦춰 줍니다. 근육이 늘어나며 버티는 일이라, 들어 올리는 힘보다 천천히 내리며 버티는 힘을 키우는 편이 쓸모 있습니다(과부하 내리기 운동).',
 ...
 *
 * 같은 날 넷을 더 더했다. 3D 근육 지도에서 이 근육들만 색이 없어 빠진 것처럼 보였다
 * (사용자분이 찾았다) — 목록에 없는 근육은 회색으로 둔다(muscle-map-3d.tsx).
 *   전면 삼각근 · 대흉근  어깨 앞쪽을 덮는 큰 근육. 공을 뿌리는 힘을 내는 쪽이라 보통 약하지
 *                        않지만, 목록에 없어 프론트 레이즈가 '중간 삼각근'으로 적혀 있었다
 *   상부 승모근          전거근·하부 승모근과 짝을 이뤄 날개뼈를 위로 돌린다
 *   손가락 신전근        팔꿈치 바깥쪽 뼈에서 시작하는 아래팔 등 쪽 근육 — 손가락 굽힘근의 짝
 * 넷 다 키우면 막는다는 근거는 없어 helps 는 비운다.
 */
export const ARMCARE_MUSCLES = [
  ...
  },
  {
    name: '전면 삼각근',
    area: 'shoulder-front',
    does: '팔을 앞으로 들어 올림 · 안으로 돌림을 거듦',
    at: '빗장뼈(쇄골) 바깥쪽 → 위팔뼈 바깥쪽 가운데',
    helps: null,
  },
  {
    name: '대흉근',
    area: 'shoulder-front',
    does: '팔을 몸 앞으로 모으고 안으로 돌림',
    at: '빗장뼈 안쪽 · 가슴뼈 · 위쪽 갈비뼈 → 위팔뼈 앞쪽 위',
    helps: null,
  },
  {
    name: '극상근',
  ...
  },
  {
    name: '상부 승모근',
    area: 'scapula',
    does: '날개뼈를 끌어올리며 위로 돌림',
    at: '뒤통수 아래 · 목 뒤 척추 → 빗장뼈 바깥쪽과 어깨 끝 뼈(견봉)',
    helps: null,
  },
  {
    name: '중부 승모근',
  ...
  },
  {
    name: '손가락 신전근',
    area: 'elbow-outer',
    does: '손가락을 폄 · 손목 젖히기를 거듦',
    at: '팔꿈치 바깥쪽 뼈(외측 상과) → 검지~새끼손가락 등',
    helps: null,
  },
  {
    name: '회외근',
