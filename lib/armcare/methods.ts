...
export type ArmcareMethod = {
   ...
   * 이 한 줄만 보이고, 아래 설명은 펼쳐야 나온다. 펼친 뒤에는 자세히 읽을 수 있게
   * 충분히 적는다 — 같은 날 "겉은 단순하게, 누르면 자세히"로 다시 정했다. 한때 두었던
   * 부담 점(1~5)도 그때 뺐다.
   */
  short: string;
  /** 하는 법 */
...
/** 화면에 늘어놓는 차례 — 가벼운 것부터. 올라가는 차례는 아니다(섞어 해도 된다) */
export const ARMCARE_METHODS: readonly ArmcareMethod[] = [
  {
    ...
    dose: '2~3세트, 8~12회. 세트 사이 30초~1분. 세트·횟수는 기준일 뿐이라, 몸이 무거운 날은 줄여도 됩니다.',
  ...
  },
  {
    ...
    caution:
      '다섯 가지 중 몸에 주는 부담이 가장 큽니다. 반대 손이나 보조자가 늘 받아 줄 수 있게 하고, 몸이 가벼운 날에만 합니다. 그래서 맞춤 루틴은 이 방식을 저절로 넣지 않습니다(내 루틴에는 직접 담을 수 있습니다).',
  },
];
