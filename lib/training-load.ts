 ...
 * 이 구간이 무슨 뜻인지 한 줄로.
 *
 * 조언(TRAINING_ADVICE)은 갈라 뒀는데 이 한 줄이 안 갈려 있어서, 운동 부하
 * 밑에 "몸이 감당해온 양 안에서 던지고 있습니다"가 붙었다. 운동을 한 사람에게
 * 던지는 이야기를 하는 셈이라 읽는 순간 앱을 못 믿게 된다.
 */
export const TRAINING_MEANING: Record<AcwrZone, string> = {
  low: '평소보다 적게 운동하고 있습니다.',
  optimal: '몸이 감당해온 양 안에서 운동하고 있습니다.',
  caution: '평소보다 빠르게 늘고 있습니다.',
  danger: '평소 감당하던 양을 크게 넘었습니다.',
};
